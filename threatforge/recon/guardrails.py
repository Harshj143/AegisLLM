"""
ThreatForge Guardrail Profiler — map content filters and safety layers.
...
from threatforge.core.profile import ThreatForgeProfile, GuardrailLevel, GuardrailProfile
