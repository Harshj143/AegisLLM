"""
ThreatForge Evolution Engine — Smart Prompt Evolution for Natural Language (SPE-NL).
...
from threatforge.evolution.crossover import crossover
from threatforge.evolution.fitness import AttackGoal, FitnessResult, evaluate_fitness
from threatforge.evolution.operators import ALL_OPERATORS, MutationOperator, get_random_operator
from threatforge.evolution.population import Individual, Population
from threatforge.providers.base import ProviderAdapter, ProviderMessage

logger = logging.getLogger("threatforge.evolution")
...
class EvolutionEngine:
    ...
    def __init__(
        ...
        from threatforge.evolution.operators import LLMMutation
