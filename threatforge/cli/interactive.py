"""
ThreatForge Interactive REPL — manual + AI-assisted red teaming.
...
from threatforge import BANNER
...
async def run_interactive(
    ...
    async with _create_provider(cfg) as prov:
        ...
        console.print(Panel(
            ...
            title="🐍 ThreatForge Interactive Mode",
            border_style="red",
            padding=(1, 2)
        ))
        ...
        while True:
            try:
                user_input = Prompt.ask("\n[bold cyan]threatforge[/bold cyan]")
...
async def _handle_command(
    ...
    if command == "/help":
        ...
        from threatforge.cli.scan import _run_recon, _print_profile
        ...
        from threatforge.cli.scan import _run_evolution
        ...
        if not session.findings:
            ...
            return
        from threatforge.cli.scan import _print_findings_table
        _print_findings_table(session)

    elif command == "/profile":
        from threatforge.cli.scan import _print_profile
        _print_profile(session)
...
"""
    console.print(Panel(help_text.strip(), title="ThreatForge Interactive Help", border_style="cyan"))
