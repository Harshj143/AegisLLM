"""
ThreatForge Database — SQLite persistence with WAL mode for concurrent access.
...
class ThreatForgeDatabase:
    ...
    def __init__(self, db_path: str = "./threatforge-sessions.db") -> None:
