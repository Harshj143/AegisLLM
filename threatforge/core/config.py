"""
ThreatForge Configuration — YAML-based configuration loading and validation.
...
class TargetConfig:
    ...
    def resolve_api_key(self) -> str:
        ...
        env_var = env_mapping.get(self.provider, "THREATFORGE_API_KEY")
...
@dataclass
class ThreatForgeConfig:
    """
    Root configuration object for a ThreatForge scan session.
    ...
    session_db: str = "./threatforge-sessions.db"

    @classmethod
    def from_yaml(cls, path: str | Path) -> ThreatForgeConfig:
    ...
    @classmethod
    def from_cli_args(cls, **kwargs: Any) -> ThreatForgeConfig:
