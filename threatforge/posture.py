"""
ThreatForge Guardrail Profile Report — recon-only security posture assessment.
...
from threatforge.core.profile import ThreatForgeProfile, GuardrailLevel
    ...
    def calculate_overall(self) -> None:
        ...
        if self.overall_score >= 0.8:
            self.recommendations.append(
                ...
                "with ThreatForge's evolution engine for bypass detection."
            )
...
def save_posture_report(report: PostureReport, output_dir: str = "./threatforge-reports") -> str:
